"""
	ShotProfileEWEM(m,d,adj=true;<keyword arguments>)

Shot Profile Elastic Wave Equation Migration and Demigration of 3D isotropic data.

# Arguments
- `m::Array{AbstractString,1}` : vector of filenames of image (comprised of [mpp;mps1;mps2])
- `d::Array{AbstractString,1}` : vector of filenames of data (comprised of [ux;uy;uz])
